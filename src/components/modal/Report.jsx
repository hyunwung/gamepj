				...
				<div className='report-reason'>
					...
					<ul>
						<li className='reason-item' onClick={()=>handleSelect(0)}>
							{select === 0 ? <div className='reason-select'><AiOutlineCheck style={{color:"white",fontSize:"20px"}}></AiOutlineCheck></div> : <div className='none-select'></div>}
						...
						<li className='reason-item' onClick={()=>handleSelect(1)}>
							{select === 1 ? <div className='reason-select'><AiOutlineCheck style={{color:"white",fontSize:"20px"}}></AiOutlineCheck></div> : <div className='none-select'></div>}
							<input type="radio" name="select" value="0" className="report-reasons"></input>
							<span className='report-reason-items'>음란물입니다.</span>
						</li>
						<li className='reason-item' onClick={()=>handleSelect(2)}>
							{select === 2 ? <div className='reason-select'><AiOutlineCheck style={{color:"white",fontSize:"20px"}}></AiOutlineCheck></div> : <div className='none-select'></div>}
							<input type="radio" name="select" value="0" className="report-reasons"></input>
							<span className='report-reason-items'>불법정보를 포함하고 있습니다.</span>
						</li>
						<li className='reason-item' onClick={()=>handleSelect(3)}>
							{select === 3 ? <div className='reason-select'><AiOutlineCheck style={{color:"white",fontSize:"20px"}}></AiOutlineCheck></div> : <div className='none-select'></div>}
							<input type="radio" name="select" value="0" className="report-reasons"></input>
							<span className='report-reason-items'>청소년에게 유해한 내용입니다.</span>
						</li>
						<li className='reason-item' onClick={()=>handleSelect(4)}>
							{select === 4 ? <div className='reason-select'><AiOutlineCheck style={{color:"white",fontSize:"20px"}}></AiOutlineCheck></div> : <div className='none-select'></div>}
							<input type="radio" name="select" value="0" className="report-reasons"></input>
							<span className='report-reason-items'>욕설/생명경시/혐오/차별적 표현입니다.</span>
						</li>
						<li className='reason-item' onClick={()=>handleSelect(5)}>
							{select === 5 ? <div className='reason-select'><AiOutlineCheck style={{color:"white",fontSize:"20px"}}></AiOutlineCheck></div> : <div className='none-select'></div>}
							<input type="radio" name="select" value="0" className="report-reasons"></input>
							<span className='report-reason-items'>개인정보 노출 게시물입니다.</span>
						</li>
						<li className='reason-item' onClick={()=>handleSelect(6)}>
							{select === 6 ? <div className='reason-select'><AiOutlineCheck style={{color:"white",fontSize:"20px"}}></AiOutlineCheck></div> : <div className='none-select'></div>}
							<input type="radio" name="select" value="0" className="report-reasons"></input>
							<span className='report-reason-items'>불쾌한 표현이 있습니다.</span>
						</li>
						<li className='reason-item' onClick={()=>handleSelect(7)}>
							{select === 7 ? <div className='reason-select'><AiOutlineCheck style={{color:"white",fontSize:"20px"}}></AiOutlineCheck></div> : <div className='none-select'></div>}
							<input type="radio" name="select" value="0" className="report-reasons"></input>
							<span className='report-reason-items'>명예훼손 또는 저작권이 침해되었습니다.</span>
						</li>
						<li className='reason-item' onClick={()=>handleSelect(8)}>
							{select === 8 ? <div className='reason-select'><AiOutlineCheck style={{color:"white",fontSize:"20px"}}></AiOutlineCheck></div> : <div className='none-select'></div>}
							<input type="radio" name="select" value="0" className="report-reasons"></input>
